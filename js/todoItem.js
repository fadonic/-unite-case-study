...
var TodoItem = (function (_super) {
    ...
    TodoItem.prototype.render = function () {
        ...
        var todoText = title.split("@");
        var todoTitle = todoText[0].trim();
        var todoLabel = todoText.slice(1).join(",");
        return (React.createElement("li", { className: classNames({
            ...
            React.createElement("div", { className: "view" },
                ...
                React.createElement("label", { onDoubleClick: function (e) { return _this.handleEdit(); } },
                    React.createElement("span", { "data-testid": 'title' }, todoTitle),
                    React.createElement("span", { "data-testid": 'label' }, todoLabel)),
