...
var TodoApp = (function (_super) {
    ...
    TodoApp.prototype.handleNewTodoKeyDown = function (val) {
        if (val) {
    ...
    TodoApp.prototype.render = function () {
        ...
        return (React.createElement("div", null,
            React.createElement(header_1.default, { handleNewTodoKeyDown: function (val) { return _this.handleNewTodoKeyDown(val); } }),
            main,
            footer));
    };
    return TodoApp;
